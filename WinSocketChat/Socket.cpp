...
Socket::Socket()
{
	...
	{
		cout << "Socket delaet mistake." << endl;
		system("pause");
		WSACleanup();
		exit(11);
	}
...
{
	TCHAR buf[] = { "1. Telephone - 50000 grn\n2. PC - 100000 grn\n3. Stol - 11000grn\n Choose tech and stonks" };
	SendData(buf);
}
